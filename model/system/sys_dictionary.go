...
import (
	"github.com/wangxin5355/vol-gin-admin-api/common"
)
...
type SysDictionary struct {
	...
	ModifyDate common.JsonTime `json:"ModifyDate" gorm:"column:ModifyDate;comment:修改时间"`
	Modifier   *string         `json:"Modifier" gorm:"column:Modifier;comment:修改人"`
	ModifyID   int             `json:"ModifyID" gorm:"column:ModifyID"`
	CreateDate common.JsonTime `json:"CreateDate" gorm:"column:CreateDate;comment:创建时间"`
