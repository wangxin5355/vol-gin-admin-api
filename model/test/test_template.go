...
type TestTemplate struct {
	//_ struct{} `entity:"TableCnName=推荐组合;TableName=RecommenPortfolio;DetailTable=RecommenPortfolioDetail;DetailTableCnName=推荐组合详情;DBServer=FundTrafficDbContext"`
